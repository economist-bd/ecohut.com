 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xP=vt("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),NP={apiKey:"AIzaSyBHFsTRQT1eopfz8NG5ux__0QKgKCnoXOE",authDomain:"support-94add.firebaseapp.com",projectId:"support-94add",storageBucket:"support-94add.firebasestorage.app",messagingSenderId:"442252148032",appId:"1:442252148032:web:722f176b1c1b52a7368ea5",measurementId:"G-GP4C34CQF9"},fE=Q_(NP),Ay=eC(fE),oi=XR(fE),ai="ecohut-web-v1",xc={productName:"১০ আইটেম স্পেশাল চকলেট কম্বো! 🍫",description:"আপনার সোনামণি কি চকলেটের জন্য বায়না ধরে? 😢 বাজারের ক্ষতিকর চকলেট না দিয়ে দিন প্রিমিয়াম কোয়ালিটি চকলেট বক্স!",price:1250,regularPrice:1490,phone:"01715247588",deliveryInside:70,deliveryOutside:130,images:["https://images.unsplash.com/photo-1623910398642-83b6f8497678?q=80&w=1000&auto=format&fit=crop"],features:[{title:"১০০% অথেনটিক",text:"সৌদি, দুবাই ও তুরস্ক থেকে ইম্পোর্টেড।"},{title:"সেরা স্বাদ",text:"বাচ্চাদের পছন্দের ১০টি ভিন্ন ফ্লেভার।"},{title:"পারফেক্ট গিফট",text:"জন্মদিন বা যেকোনো উপলক্ষে সেরা উপহার।"}]},DP=t=>new Promise(e=>{const n=new FileReader;n.readAsDataURL(t),n.onload=r=>{const i=new Image;i.src=r.target.result,i.onload=()=>{const s=document.createElement("canvas"),o=600,l=o/i.width;s.width=o,s.height=i.height*l,s.getContext("2d").drawImage(i,0,0,s.width,s.height),e(s.toDataURL("image/jpeg",.7))}}});function VP(){const[t,e]=Pe.useState(null),[n,r]=Pe.useState(xc),[i,s]=Pe.useState(!1),[o,l]=Pe.useState(!1),[u,h]=Pe.useState(!1),[f,p]=Pe.useState(!1),[m,k]=Pe.useState("orders"),[x,N]=Pe.useState([]),[O,I]=Pe.useState(0),[v,S]=Pe.useState({name:"",phone:"",address:"",quantity:1,deliveryArea:"inside_dhaka"});Pe.useEffect(()=>{(async()=>{try{await MA(Ay);const W=bs(oi,"artifacts",ai,"public","siteConfig"),G=await hP(W);G.exists()?r({...xc,...G.data()}):await Ey(W,xc)}catch(W){console.error("Init Error:",W)}})(),localStorage.getItem("ecohut_admin")==="true"&&h(!0),$A(Ay,e)},[]),Pe.useEffect(()=>{if(u){const B=aP(py(oi,"artifacts",ai,"public","data","orders"),lP("orderDate","desc")),M=mP(B,W=>{const G=W.docs.map(ce=>({id:ce.id,...ce.data()}));N(G)});return()=>M()}},[u]);const V=()=>{prompt("অ্যাডমিন পাসওয়ার্ড দিন:")==="admin123"?(localStorage.setItem("ecohut_admin","true"),h(!0),p(!0),alert("স্বাগতম অ্যাডমিন!")):alert("ভুল পাসওয়ার্ড!")},z=async()=>{if(u){s(!0);try{await Ey(bs(oi,"artifacts",ai,"public","siteConfig"),n),alert("সেভ হয়েছে!")}catch(B){console.error(B),alert("সেভ করতে সমস্যা হয়েছে")}s(!1)}},j=async(B,M)=>{if(u)try{await dP(bs(oi,"artifacts",ai,"public","data","orders",B),{status:M})}catch(W){console.error("Status update failed:",W),alert("স্ট্যাটাস আপডেট হয়নি!")}},w=async B=>{if(u&&window.confirm("আপনি কি নিশ্চিত এই অর্ডারটি ডিলিট করতে চান? এটি আর ফিরিয়ে আনা যাবে না।"))try{await fP(bs(oi,"artifacts",ai,"public","data","orders",B))}catch(M){console.error("Delete failed:",M),alert("ডিলিট হয়নি!")}},y=async B=>{const M=B.target.files[0];if(M){const W=await DP(M);r(G=>({...G,images:[...G.images,W]}))}},_=B=>{r(M=>({...M,images:M.images.filter((W,G)=>G!==B)})),O>=B&&O>0&&I(O-1)},E=(B,M,W)=>{const G=[...n.features];G[B]={...G[B],[M]:W},r({...n,features:G})},C=()=>{const B=v.deliveryArea==="inside_dhaka"?n.deliveryInside:n.deliveryOutside;return n.price*v.quantity+B},R=B=>{const{name:M,value:W}=B.target;S(G=>({...G,[M]:W}))},T=B=>{S(M=>({...M,quantity:Math.max(1,M.quantity+B)}))},ct=async B=>{if(B.preventDefault(),!t)return alert("অপেক্ষা করুন...");s(!0);try{await pP(py(oi,"artifacts",ai,"public","data","orders"),{...v,totalPrice:C(),productName:n.productName,orderDate:gP(),status:"new",userId:t.uid}),l(!0),S({name:"",phone:"",address:"",quantity:1,deliveryArea:"inside_dhaka"})}catch{alert("অর্ডার প্লেস করতে সমস্যা হয়েছে।")}finally{s(!1)}},an=B=>{switch(B){case"new":return A.jsx("span",{className:"bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full font-bold",children:"নতুন"});case"confirmed":return A.jsx("span",{className:"bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full font-bold",children:"কনফার্ম"});case"shipped":return A.jsx("span",{className:"bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full font-bold",children:"পাঠানো হয়েছে"});case"delivered":return A.jsx("span",{className:"bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-bold",children:"ডেলিভারি সম্পন্ন"});case"cancelled":return A.jsx("span",{className:"bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full font-bold",children:"বাতিল"});default:return A.jsx("span",{className:"bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full font-bold",children:B})}},Ar=`
    @keyframes chase { 
      0% { left: 110%; } 
      100% { left: -20%; } 
    }
  ...
  `;return o?A.jsx("div",{className:"min-h-screen kid-pattern flex items-center justify-center p-4",children:A.jsxs("div",{className:"bg-white p-8 rounded-3xl shadow-2xl max-w-md w-full text-center border-4 border-yellow-400",children:[A.jsx(kP,{className:"w-16 h-16 text-green-600 mx-auto mb-4"}),A.jsx("h2",{className:"text-3xl font-extrabold text-purple-600 mb-4",children:"অর্ডার কনফার্ম! 🎉"}),A.jsx("p",{className:"text-gray-600 mb-6",children:"ধন্যবাদ! আমরা শীঘ্রই কল করব।"}),A.jsx("button",{onClick:()=>l(!1),className:"bg-purple-600 text-white px-8 py-3 rounded-full font-bold",children:"আরো অর্ডার করুন"})]})}):A.jsxs("div",{className:"font-sans text-gray-800 kid-pattern min-h-screen pb-24 overflow-x-hidden relative",children:[A.jsx("style",{children:Ar}),A.jsx("button",{onClick:V,className:"fixed bottom-4 left-4 z-50 bg-gray-800 text-white p-3 rounded-full opacity-60 hover:opacity-100 transition shadow-lg hover:scale-110",title:"Admin Login",children:A.jsx(TP,{size:20})}),f&&A.jsx("div",{className:"fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-2 sm:p-4",children:A.jsxs("div",{className:"bg-white rounded-2xl w-full max-w-5xl h-[90vh] shadow-2xl relative flex flex-col overflow-hidden",children:[A.jsxs("div",{className:"bg-purple-100 p-4 flex justify-between items-center border-b",children:[A.jsxs("h2",{className:"text-xl md:text-2xl font-bold flex items-center gap-2 text-purple-800",children:[A.jsx(CP,{size:24})," অ্যাডমিন প্যানেল"]}),A.jsx("button",{onClick:()=>p(!1),className:"text-gray-500 hover:text-red-500 bg-white p-2 rounded-full shadow hover:scale-110 transition",children:A.jsx(xP,{size:20})})]}),A.jsxs("div",{className:"flex bg-white border-b",children:[A.jsxs("button",{onClick:()=>k("orders"),className:`flex-1 py-3 font-bold text-center flex items-center justify-center gap-2 transition ${m==="orders"?"text-purple-700 border-b-4 border-purple-600 bg-purple-50":"text-gray-500 hover:bg-gray-50"}`,children:[A.jsx(Ty,{size:18})," অর্ডার লিস্ট (",x.length,")"]}),A.jsxs("button",{onClick:()=>k("config"),className:`flex-1 py-3 font-bold text-center flex items-center justify-center gap-2 transition ${m==="config"?"text-purple-700 border-b-4 border-purple-600 bg-purple-50":"text-gray-500 hover:bg-gray-50"}`,children:[A.jsx(SP,{size:18})," সেটিংস"]})]}),A.jsxs("div",{className:"flex-1 overflow-y-auto p-4 md:p-6 bg-gray-50",children:[m==="orders"&&A.jsx("div",{className:"space-y-4",children:x.length===0?A.jsxs("div",{className:"text-center py-20 text-gray-500",children:[A.jsx(Ty,{size:48,className:"mx-auto mb-4 opacity-20"}),A.jsx("p",{children:"কোন অর্ডার পাওয়া যায়নি"})]}):x.map(B=>A.jsx("div",{className:"bg-white p-4 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition",children:A.jsxs("div",{className:"flex flex-col md:flex-row justify-between gap-4",children:[A.jsxs("div",{className:"flex-1",children:[A.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[A.jsx("h3",{className:"font-bold text-lg text-gray-800",children:B.name}),an(B.status)]}),A.jsxs("p",{className:"text-sm text-gray-600 flex items-center gap-1",children:[A.jsx(Iy,{size:12})," ",B.phone]}),A.jsx("p",{className:"text-sm text-gray-600 mt-1 bg-gray-50 p-2 rounded border border-dashed",children:B.address}),A.jsx("p",{className:"text-xs text-gray-400 mt-2",children:B.orderDate?new Date(B.orderDate.seconds*1e3).toLocaleString("bn-BD"):"Time unknown"})]}),A.jsxs("div",{className:"md:text-right flex flex-col justify-between",children:[A.jsxs("div",{children:[A.jsxs("p",{className:"text-sm font-semibold text-gray-500",children:["পরিমাণ: ",B.quantity," টি"]}),A.jsxs("p",{className:"text-xl font-black text-purple-700",children:["৳",B.totalPrice]}),A.jsx("p",{className:"text-xs text-gray-400",children:B.deliveryArea==="inside_dhaka"?"ঢাকার ভিতরে":"ঢাকার বাইরে"})]}),A.jsxs("div",{className:"flex flex-wrap gap-2 mt-3 md:justify-end",children:[A.jsxs("select",{value:B.status,onChange:M=>j(B.id,M.target.value),className:"border rounded px-2 py-1 text-sm bg-white cursor-pointer",children:[A.jsx("option",{value:"new",children:"নতুন"}),A.jsx("option",{value:"confirmed",children:"কনফার্ম"}),A.jsx("option",{value:"shipped",children:"পাঠানো হয়েছে"}),A.jsx("option",{value:"delivered",children:"ডেলিভারি সম্পন্ন"}),A.jsx("option",{value:"cancelled",children:"বাতিল"})]}),A.jsx("button",{onClick:()=>w(B.id),className:"bg-red-50 text-red-500 p-1.5 rounded hover:bg-red-500 hover:text-white transition",title:"Delete Order",children:A.jsx(Sy,{size:16})})]})]})]})},B.id))}),m==="config"&&A.jsxs("div",{className:"space-y-6",children:[A.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[A.jsxs("div",{children:[A.jsx("label",{className:"block text-sm font-bold mb-1",children:"প্রোডাক্টের নাম"}),A.jsx("input",{type:"text",value:n.productName,onChange:B=>r({...n,productName:B.target.value}),className:"w-full border p-2 rounded focus:ring-2 focus:ring-purple-200 outline-none"})]}),A.jsxs("div",{children:[A.jsx("label",{className:"block text-sm font-bold mb-1",children:"ফোন নাম্বার"}),A.jsx("input",{type:"text",value:n.phone,onChange:B=>r({...n,phone:B.target.value}),className:"w-full border p-2 rounded focus:ring-2 focus:ring-purple-200 outline-none"})]}),A.jsxs("div",{children:[A.jsx("label",{className:"block text-sm font-bold mb-1",children:"বর্তমান দাম (৳)"}),A.jsx("input",{type:"number",value:n.price,onChange:B=>r({...n,price:parseInt(B.target.value)}),className:"w-full border p-2 rounded focus:ring-2 focus:ring-purple-200 outline-none"})]}),A.jsxs("div",{children:[A.jsx("label",{className:"block text-sm font-bold mb-1",children:"রেগুলার দাম (৳)"}),A.jsx("input",{type:"number",value:n.regularPrice,onChange:B=>r({...n,regularPrice:parseInt(B.target.value)}),className:"w-full border p-2 rounded focus:ring-2 focus:ring-purple-200 outline-none"})]})]}),A.jsxs("div",{children:[A.jsx("label",{className:"block text-sm font-bold mb-1",children:"বর্ণনা"}),A.jsx("textarea",{rows:"3",value:n.description,onChange:B=>r({...n,description:B.target.value}),className:"w-full border p-2 rounded focus:ring-2 focus:ring-purple-200 outline-none"})]}),A.jsxs("div",{className:"border-t pt-4",children:[A.jsx("label",{className:"block text-sm font-bold mb-3 text-purple-700",children:"বৈশিষ্ট্যসমূহ (Features)"}),A.jsx("div",{className:"grid gap-4",children:n.features.map((B,M)=>A.jsxs("div",{className:"flex flex-col md:flex-row gap-2 bg-white p-2 rounded border shadow-sm",children:[A.jsx("input",{className:"border p-2 rounded font-bold md:w-1/3",value:B.title,onChange:W=>E(M,"title",W.target.value),placeholder:"Title"}),A.jsx("input",{className:"border p-2 rounded w-full",value:B.text,onChange:W=>E(M,"text",W.target.value),placeholder:"Description"})]},M))})]}),A.jsxs("div",{className:"border-t pt-4",children:[A.jsx("label",{className:"block text-sm font-bold mb-3",children:"ছবি ম্যানেজমেন্ট (ড্র্যাগ বা ক্লিক করে ছবি দিন)"}),A.jsxs("div",{className:"flex flex-wrap gap-4",children:[n.images.map((B,M)=>A.jsxs("div",{className:"relative w-24 h-24 border rounded overflow-hidden group shadow-sm",children:[A.jsx("img",{src:B,alt:"Product",className:"w-full h-full object-cover"}),A.jsx("button",{onClick:()=>_(M),className:"absolute top-0 right-0 bg-red-600/80 text-white p-1 opacity-100 hover:bg-red-600 transition",children:A.jsx(Sy,{size:14})})]},M)),A.jsxs("label",{className:"w-24 h-24 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:bg-white hover:border-purple-500 transition",children:[A.jsx(PP,{className:"text-gray-400"}),A.jsx("span",{className:"text-xs text-gray-500 mt-1",children:"Add Photo"}),A.jsx("input",{type:"file",accept:"image/*",onChange:y,className:"hidden"})]})]})]}),A.jsx("div",{className:"pt-4 border-t flex justify-end",children:A.jsx("button",{onClick:z,className:"bg-purple-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-purple-700 flex items-center gap-2 shadow-lg hover:shadow-xl transform transition hover:-translate-y-1",children:i?"সেভ হচ্ছে...":A.jsxs(A.Fragment,{children:[A.jsx(IP,{size:18})," সেটিংস সেভ করুন"]})})})]})]})]})}),A.jsxs("div",{className:"animate-chase",children:[A.jsxs("div",{className:"relative transform scale-150 mr-12",children:[A.jsx("span",{className:"text-4xl absolute -left-4 -top-2 wing-flap",children:"🕊️"}),A.jsx("span",{className:"text-5xl drop-shadow-lg",children:"🍫"}),A.jsx("span",{className:"text-4xl absolute -right-4 -top-2 wing-flap",style:{animationDelay:"0.1s"},children:"🕊️"})]}),A.jsx("div",{className:"transform scale-150 bouncing-child",children:A.jsx("span",{className:"text-6xl inline-block",style:{transform:"scaleX(1)"},children:"🏃‍♂️"})})]}),A.jsxs("div",{className:"bg-purple-600 text-white py-2 px-4 text-sm font-bold text-center md:flex md:justify-between md:items-center shadow-md",children:[A.jsxs("p",{className:"flex items-center justify-center gap-2",children:[A.jsx(EP,{size:16})," বাচ্চাদের জন্য সেরা গিফট বক্স!"]}),A.jsx("div",{className:"flex justify-center gap-4 mt-1 md:mt-0",children:A.jsxs("a",{href:`tel:${n.phone}`,className:"flex items-center gap-1 hover:text-yellow-300",children:[A.jsx(Iy,{size:14})," ",n.phone]})})]}),A.jsx("nav",{className:"bg-white/90 backdrop-blur-md sticky top-0 z-40 border-b-4 border-yellow-400 shadow-sm",children:A.jsxs("div",{className:"container mx-auto px-4 py-3 flex justify-between items-center",children:[A.jsxs("div",{className:"flex items-center gap-2",children:[A.jsx("span",{className:"text-4xl",children:"🍬"}),A.jsx("h1",{className:"text-3xl font-black text-purple-700 tracking-tight",style:{fontFamily:"cursive"},children:"EcoHut"})]}),A.jsxs("a",{href:"#order-form",className:"bg-yellow-400 text-purple-900 px-6 py-2 rounded-full font-black text-sm hover:bg-yellow-500 transition shadow-lg flex items-center gap-2 transform hover:scale-105 border-2 border-yellow-500",children:[A.jsx(AP,{size:20})," অর্ডার করুন"]})]})}),A.jsx("div",{className:"py-8 md:py-12",children:A.jsx("div",{className:"container mx-auto px-4",children:A.jsxs("div",{className:"bg-white rounded-3xl p-6 md:p-10 shadow-xl border-4 border-purple-100 flex flex-col md:flex-row gap-8 items-start",children:[A.jsxs("div",{className:"w-full md:w-1/2 relative",children:[A.jsxs("div",{className:"relative aspect-square bg-yellow-50 rounded-2xl overflow-hidden shadow-2xl border-4 border-white",children:[A.jsx("img",{src:n.images[O]||n.images[0],alt:"Product Main",className:"w-full h-full object-cover transition-all duration-300"}),A.jsxs("div",{className:"absolute top-4 right-4 bg-red-500 text-white px-5 py-2 rounded-full font-black shadow-lg text-lg animate-pulse border-2 border-white",children:[Math.round((n.regularPrice-n.price)/n.regularPrice*100),"% ছাড়!"]})]}),A.jsx("div",{className:"flex gap-3 mt-4 overflow-x-auto pb-2 scrollbar-hide",children:n.images.map((B,M)=>A.jsx("div",{onClick:()=>I(M),className:`w-20 h-20 flex-shrink-0 rounded-lg border-2 overflow-hidden cursor-pointer transition transform hover:scale-105 ${O===M?"border-purple-600 ring-2 ring-purple-300":"border-purple-200"}`,children:A.jsx("img",{src:B,alt:"thumb",className:"w-full h-full object-cover"})},M))})]}),A.jsxs("div",{className:"w-full md:w-1/2 space-y-6 text-center md:text-left",children:[A.jsxs("div",{children:[A.jsx("h1",{className:"text-3xl md:text-5xl font-black text-gray-800 leading-tight mb-2 drop-shadow-sm",children:n.productName}),A.jsxs("div",{className:"flex justify-center md:justify-start items-center gap-2 mb-6",children:[A.jsx("div",{className:"flex text-yellow-400 filter drop-shadow",children:[...Array(5)].map((B,M)=>A.jsx(RP,{fill:"currentColor",size:24},M))}),A.jsx("span",{className:"text-gray-500 font-bold",children:"(২০০+ হ্যাপি কিডস)"})]}),A.jsx("div",{className:"inline-block bg-yellow-100 px-6 py-2 rounded-2xl border-2 border-yellow-400 mb-4 transform -rotate-2",children:A.jsxs("div",{className:"flex items-center gap-3",children:[A.jsxs("span",{className:"text-4xl font-black text-purple-700",children:["৳",n.price]}),A.jsxs("span",{className:"text-xl text-gray-500 line-through decoration-red-500 decoration-2",children:["৳",n.regularPrice]})]})})]}),A.jsx("div",{className:"text-gray-700 space-y-4 text-lg bg-white/50 p-4 rounded-xl border border-purple-100",children:A.jsx("p",{children:n.description})}),A.jsxs("div",{className:"pt-4",children:[A.jsx("a",{href:"#order-form",className:"block w-full text-center bg-gradient-to-r from-purple-600 to-purple-500 text-white py-4 rounded-2xl font-black text-2xl shadow-xl hover:from-purple-700 hover:to-purple-600 transition transform hover:-translate-y-1 hover:scale-105",children:"অর্ডার করতে ক্লিক করুন 🛒"}),A.jsxs("p",{className:"text-center text-gray-500 font-bold mt-3",children:["কল করুন: ",A.jsx("span",{className:"text-purple-700 text-lg",children:n.phone})]})]})]})]})})}),A.jsx("div",{className:"py-8 container mx-auto px-4",children:A.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:n.features.map((B,M)=>A.jsxs("div",{className:`bg-white p-6 rounded-2xl shadow-lg border-b-4 ${M===0?"border-green-500":M===1?"border-yellow-500":"border-blue-500"} text-center transform hover:-translate-y-1 transition`,children:[A.jsx("h3",{className:"font-bold text-xl mb-2",children:B.title}),A.jsx("p",{className:"text-gray-600",children:B.text})]},M))})}),A.jsx("div",{id:"order-form",className:"py-12",children:A.jsx("div",{className:"container mx-auto px-4",children:A.jsxs("div",{className:"max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-white ring-4 ring-purple-100",children:[A.jsxs("div",{className:"bg-purple-600 py-6 text-center relative overflow-hidden",children:[A.jsx("div",{className:"absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/food.png')]"}),A.jsx("h2",{className:"text-2xl md:text-3xl font-black text-white relative z-10",children:"অর্ডার কনফার্ম করুন 👇"})]}),A.jsxs("form",{onSubmit:ct,className:"p-6 md:p-8 space-y-5",children:[A.jsxs("div",{className:"flex justify-between items-center bg-yellow-50 p-4 rounded-xl border-2 border-yellow-200 border-dashed",children:[A.jsxs("div",{className:"flex items-center gap-3",children:[A.jsx("div",{className:"text-3xl",children:"🎁"}),A.jsxs("div",{children:[A.jsx("p",{className:"font-bold text-gray-800",children:"Combo Pack"}),A.jsx("p",{className:"text-xs text-gray-500 font-bold text-purple-600",children:"Premium Item"})]})]}),A.jsxs("span",{className:"font-black text-purple-700 text-xl",children:["৳",n.price]})]}),A.jsxs("div",{className:"space-y-4",children:[A.jsx("input",{required:!0,type:"text",name:"name",value:v.name,onChange:R,placeholder:"আপনার নাম...",className:"w-full px-5 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 outline-none font-medium"}),A.jsx("input",{required:!0,type:"tel",name:"phone",value:v.phone,onChange:R,placeholder:"মোবাইল নাম্বার...",className:"w-full px-5 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 outline-none font-medium"}),A.jsx("textarea",{required:!0,name:"address",value:v.address,onChange:R,rows:"2",placeholder:"ঠিকানা (বাসা, রোড, এলাকা)...",className:"w-full px-5 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 outline-none font-medium"}),A.jsxs("div",{className:"bg-gray-50 p-4 rounded-xl text-center",children:[A.jsx("label",{className:"block text-sm font-bold text-gray-700 mb-2",children:"কয়টি বক্স নিবেন?"}),A.jsxs("div",{className:"flex items-center justify-center gap-6",children:[A.jsx("button",{type:"button",onClick:()=>T(-1),className:"w-10 h-10 rounded-full bg-white shadow border font-bold text-red-500",children:"-"}),A.jsx("span",{className:"text-2xl font-black w-8",children:v.quantity}),A.jsx("button",{type:"button",onClick:()=>T(1),className:"w-10 h-10 rounded-full bg-white shadow border font-bold text-green-500",children:"+"})]})]}),A.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[A.jsxs("label",{className:`cursor-pointer border-2 rounded-xl p-3 flex flex-col items-center justify-center gap-1 transition ${v.deliveryArea==="inside_dhaka"?"border-purple-500 bg-purple-50 text-purple-700":"border-gray-200"}`,children:[A.jsx("input",{type:"radio",name:"deliveryArea",value:"inside_dhaka",checked:v.deliveryArea==="inside_dhaka",onChange:R,className:"hidden"}),A.jsx("span",{className:"font-bold",children:"ঢাকার ভিতরে"}),A.jsxs("span",{className:"text-sm bg-white px-2 rounded-full border",children:["৳",n.deliveryInside]})]}),A.jsxs("label",{className:`cursor-pointer border-2 rounded-xl p-3 flex flex-col items-center justify-center gap-1 transition ${v.deliveryArea==="outside_dhaka"?"border-purple-500 bg-purple-50 text-purple-700":"border-gray-200"}`,children:[A.jsx("input",{type:"radio",name:"deliveryArea",value:"outside_dhaka",checked:v.deliveryArea==="outside_dhaka",onChange:R,className:"hidden"}),A.jsx("span",{className:"font-bold",children:"ঢাকার বাইরে"}),A.jsxs("span",{className:"text-sm bg-white px-2 rounded-full border",children:["৳",n.deliveryOutside]})]})]})]}),A.jsxs("div",{className:"bg-gray-50 p-5 rounded-xl border border-gray-200 mt-2",children:[A.jsxs("div",{className:"flex justify-between items-center mb-1 text-sm",children:[A.jsx("span",{className:"text-gray-600",children:"সাবটোটাল"}),A.jsxs("span",{className:"font-bold",children:["৳",n.price*v.quantity]})]}),A.jsxs("div",{className:"flex justify-between items-center mb-3 text-sm",children:[A.jsx("span",{className:"text-gray-600",children:"ডেলিভারি চার্জ"}),A.jsxs("span",{className:"font-bold",children:["৳",v.deliveryArea==="inside_dhaka"?n.deliveryInside:n.deliveryOutside]})]}),A.jsxs("div",{className:"flex justify-between items-center text-2xl font-black text-gray-800 border-t-2 border-dashed border-gray-300 pt-3",children:[A.jsx("span",{children:"সর্বমোট"}),A.jsxs("span",{className:"text-purple-600",children:["৳",C()]})]})]}),A.jsx("button",{type:"submit",disabled:i,className:`w-full bg-purple-600 text-white font-black text-xl py-4 rounded-xl shadow-xl hover:bg-purple-700 transition flex justify-center items-center gap-2 ${i?"opacity-70":""}`,children:i?"অর্ডার হচ্ছে...":A.jsxs("span",{children:["অর্ডার কনফার্ম করুন ",A.jsx(wP,{size:20,className:"inline"})]})})]})]})})}),A.jsxs("footer",{className:"bg-purple-900 text-purple-200 py-10 border-t-4 border-yellow-400 text-center",children:[A.jsx("h3",{className:"text-3xl font-bold text-white mb-2",style:{fontFamily:"cursive"},children:"EcoHut"}),A.jsx("p",{className:"text-sm opacity-50",children:"© 2024 EcoHut. Made with 💜 for Kids."})]})]})}F_(document.getElementById("root")).render(A.jsx(Pe.StrictMode,{children:A.jsx(VP,{})}));
